...
namespace Colors
{
	...
	static constexpr Color Brown = MakeRGB( 100u,50u,40u );
	static constexpr Color SoftRed = MakeRGB( 200u,50u,50u );
	static constexpr Color SoftGreen = MakeRGB( 50u,200u,50u );
	static constexpr Color DarkGray = MakeRGB( 0x60u,0x60u,0x60u );
}